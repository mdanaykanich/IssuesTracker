$(function () {
    ...
    function getIssues(projectId) {
        ...
        $.ajax({
            type: 'GET',
            url: '/Home/GetSortedIssues/' + projectId,
            dataType: 'json',
            success: function (result) {
                ...
                for (let i = 0; i < result.inprogressIssues.length; i++) {
                    ...
                    spanr1.appendChild(spanSummary);
                    spanr1.innerHTML += result.inprogressIssues[i].Summary;
                    divcl1.appendChild(spanr1);
                    divr1.appendChild(divcl1);
                    li.appendChild(divr1);

                    spanr2.appendChild(spanPriority);
                    spanr2.innerHTML += result.inprogressIssues[i].Priority;
                    divcl2.appendChild(spanr2);
                    divr2.appendChild(divcl2);
                    li.appendChild(divr2);

                    spanr3.appendChild(spanAssignee);
                    spanr3.innerHTML += result.inprogressIssues[i].Assignee;
                    divcl3.appendChild(spanr3);
                    divr3.appendChild(divcl3);
                    li.appendChild(divr3);

                    ulInprogressIssues.appendChild(li);
                }

                for (let i = 0; i < result.doneIssues.length; i++) {
                    let li = document.createElement('li');
                    li.setAttribute('class', 'list-group-item kanban-li');
                    ...
                    spanr1.appendChild(spanSummary);
                    spanr1.innerHTML += result.doneIssues[i].Summary;
                    divcl1.appendChild(spanr1);
                    divr1.appendChild(divcl1);
                    li.appendChild(divr1);

                    spanr2.appendChild(spanPriority);
                    spanr2.innerHTML += result.doneIssues[i].Priority;
                    divcl2.appendChild(spanr2);
                    divr2.appendChild(divcl2);
                    li.appendChild(divr2);

                    spanr3.appendChild(spanAssignee);
                    spanr3.innerHTML += result.doneIssues[i].Assignee;
                    divcl3.appendChild(spanr3);
                    divr3.appendChild(divcl3);
                    li.appendChild(divr3);

                    ulDoneIssues.appendChild(li);
                }
            }
        });
    }
